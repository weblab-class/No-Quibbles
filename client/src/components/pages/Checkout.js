...
class Checkout extends Component {
    ...
    render() { 
      const checkoutItems = this.state.lastcart.map((itemid) => {
          return <CheckoutItem itemid={itemid}/>
        }) 
      console.log(this.state.lastcart)
      const checkoutTotal = <CheckoutTotal cart={this.state.lastcart}/>

        return (
            <>
            {/* {console.log(this.state.user.cart)} */}
            <div className="Cart-container">
              <h3>Checkout complete - thanks for shopping!</h3>
              ...
              <header className="header">
                <div className="header__top">
                  ...
                  <div className="header__meta">
                    <span className="header__date">{this.getCurrentDate()}</span>
                ...
                <div className="header__greeting">
                  ...
                  <span className="header__count">You've purchased {this.state.lastcart.length} items in our EventsMall.</span>
